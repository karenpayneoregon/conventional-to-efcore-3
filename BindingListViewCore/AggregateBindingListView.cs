...
using BindingListViewCore.Properties;
    ...
    public class AggregateBindingListView<T> : Component, IBindingListView, IList, IRaiseItemChangedEvents, ICancelAddNew, ITypedList, IEnumerable<T>
    {
        ...
        public IList SourceLists
        {
            ...
            set
            {
                if (value == null)
                {
                    throw new ArgumentNullException("SourceLists", Resources.SourceListsNull);
                }
        ...
        public void ApplyFilter(Predicate<T> includeItem)
        {
            if (includeItem == null)
            {
                throw new ArgumentNullException("includeItem", Resources.IncludeDelegateCannotBeNull);
            }
        ...
        */
        ...
        void IList.Clear()
        {
            throw new NotSupportedException(Resources.CannotClearView);
        }
        ...
        {
            throw new NotSupportedException(Resources.CannotInsertItem);
        }
        ...
        {
            get { throw new NotSupportedException(Resources.SyncAccessNotSupported); }
        }
